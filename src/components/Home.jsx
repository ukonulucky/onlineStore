    ...
    return (
        <div className="home">
            ...
            <div className="home_row">
                <Product id={ Math.random() } price={7.95} title="Nature Long Sleeve T-Shirt"  rating={4} image={sound} comment={ "Add To Basket"}  />
                <Product id={ Math.random()  } price={9.45} title="Sons Of Odin Hoodie"  rating={4} image={shirt} comment={ "Add To Basket"}  />
                <Product id={ Math.random()  }  price={8.39} title="Eye Of The Beholder T-Shirt"  rating={4} image={fridge } comment={ "Add To Basket"} />
                </div>
            <div className="home_row">
                ...
                <Product id={ Math.random()  }  price={9.99} title="Strongest Of Warriors"  rating={4} image={ shoeImage } comment={ "Add To Basket"} />
              
            </div>
              
            <div className="home_row">
               <Product id={ Math.random()  }  price={7.99} title="Glorious Vikings Hoodie"  rating={4} image={pic11} comment={ "Add To Basket"} />
                <Product id={ Math.random()  }  price={4.68} title="Hook Up With Big Girls T-Shirt"  rating={5} image={furniture} comment={ "Add To Basket"} />
                <Product id={ Math.random()  }  price={9.45} title="Bass Fishing Long Sleeve"  rating={4} image={kitchen} comment={ "Add To Basket"} />
            </div>         
        </div>
    )
}
